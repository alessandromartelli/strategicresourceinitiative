  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-primary text-white py-16 sm:py-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-3xl">
            <h1 className="font-merriweather text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">
              Contact Us
            </h1>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-merriweather text-primary font-bold mb-6 sm:mb-8">
                Get in Touch
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div>
                  <Button type="submit" className="bg-primary hover:bg-primary/90 text-white px-6 sm:px-8 py-2 sm:py-3 h-auto w-full sm:w-auto text-sm sm:text-base">
                    Send Message
                  </Button>
                </div>
              </form>
            ...
            <div>
              {/* Map Placeholder */}
              <div className="w-full h-60 sm:h-80 bg-gray-200 mb-6 sm:mb-8 rounded-lg overflow-hidden">
              ...
              <div className="space-y-4 sm:space-y-6">
                <h3 className="text-xl sm:text-2xl font-merriweather text-primary font-bold">
                  Contact Information
                </h3>
                
                <div>
                  <h4 className="font-semibold mb-2 text-sm sm:text-base">Global Headquarters</h4>
                ...
                <div>
                  ...
                  <a href="mailto:info@sri-advisory.com" className="text-accent hover:underline text-sm sm:text-base">
                    info@sri-advisory.com
                  </a>
                </div>
                
                <div>
                  <h4 className="font-semibold mb-2 text-sm sm:text-base">Connect with us</h4>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-merriweather text-primary font-bold text-center mb-8 sm:mb-12">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
              <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">How do you charge for your services?</h3>
              <p className="text-gray-700 text-sm sm:text-base">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
              <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Do you work with public sector clients?</h3>
              <p className="text-gray-700 text-sm sm:text-base">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
              <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">What regions do you operate in?</h3>
              <p className="text-gray-700 text-sm sm:text-base">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-lg mx-auto">
              <Input
                ...
                required
              />
              <Button type="submit" className="bg-primary hover:bg-primary/90 text-white whitespace-nowrap h-10 sm:h-12 text-sm sm:text-base">
                Subscribe
              </Button>
            </form>
