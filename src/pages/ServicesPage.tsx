        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <Tabs defaultValue="sector" onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid grid-cols-1 md:grid-cols-3 mb-16 h-auto p-2 bg-white border border-gray-200 rounded-xl shadow-sm">
                <TabsTrigger 
                  value="sector" 
                  className="py-4 px-6 text-base font-medium rounded-lg data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm"
                >
              ...
              <TabsContent value="sector" className="pt-8">
                  ...
                  <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {[
                        ...
                        <div 
                          key={index}
                          className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md hover:border-gray-300 transition-all duration-300"
                        >
                          <h3 className="text-lg font-semibold mb-3 text-gray-900">
                            {service}
                          </h3>
                          <p className="text-gray-600 text-sm leading-relaxed">
                            Strategic guidance and technical expertise for sustainable infrastructure development.
                          </p>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      {[
                        ...
                        <div 
                          key={index}
                          className="bg-white border border-gray-200 rounded-xl p-8 hover:shadow-md hover:border-gray-300 transition-all duration-300"
                        >
              ...
              <TabsContent value="ifi" className="pt-8">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                  <div className="bg-gray-50 p-8 border-b border-gray-200">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
                  ...
                  {[
                    ...
                    <div key={index} className="relative">
                      ...
                      <div className="flex justify-center mb-12">
                        <div className="w-16 h-16 rounded-full bg-white border-3 border-primary shadow-lg flex items-center justify-center text-primary font-bold text-xl relative z-10 hover:scale-105 transition-transform duration-300">
                          {step.number}
                        </div>
                      </div>
                      
                      {/* Content Card */}
                      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm hover:shadow-lg hover:border-gray-300 transition-all duration-300 min-h-[180px]">
                        <h3 className="text-lg font-semibold mb-4 text-gray-900 text-center leading-tight">
                          {step.title}
                        </h3>
            ...
            <div className="lg:hidden">
              <div className="relative">
                {/* Vertical Line */}
                <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-transparent via-gray-300 to-transparent"></div>
                ...
                <div className="space-y-12">
                  {[
                    ...
                    <div key={index} className="relative flex items-start gap-8">
                      {/* Step Circle */}
                      <div className="w-16 h-16 rounded-full bg-white border-3 border-primary shadow-lg flex items-center justify-center text-primary font-bold text-xl relative z-10 flex-shrink-0">
                        {step.number}
                      </div>
